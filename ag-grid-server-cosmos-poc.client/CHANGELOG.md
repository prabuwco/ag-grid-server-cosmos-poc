...
- Create Angular project with ng: `ng new ag-grid-server-cosmos-poc.client --defaults --skip-install --skip-git `.
...
- Create project file (`ag-grid-server-cosmos-poc.client.esproj`).
