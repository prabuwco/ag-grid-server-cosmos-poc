...
import { CellSelectionModule, ValidationModule, ColumnAutoSizeModule, DateFilterModule, LicenseManager, ModuleRegistry, NumberFilterModule, PaginationModule, ServerSideRowModelModule, TextFilterModule } from 'ag-grid-enterprise';
...
ModuleRegistry.registerModules([ServerSideRowModelModule,
  PaginationModule,CellSelectionModule,TextFilterModule,
  DateFilterModule,NumberFilterModule,ColumnAutoSizeModule,ValidationModule]);
