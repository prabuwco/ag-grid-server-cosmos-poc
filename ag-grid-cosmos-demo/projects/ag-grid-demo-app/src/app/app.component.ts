...
export class AppComponent implements AfterViewInit {
  ...
  @ViewChild(AgGridServerSideComponent) agGridComponent!: AgGridServerSideComponent<ProductItem>;
  ...
  public currentGridData: ProductItem[] = []; // To store currently displayed data
